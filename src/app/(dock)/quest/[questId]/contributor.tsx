      ...
      <div className="flex flex-col gap-4 md:gap-6 p-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-stretch">
          <div className="md:w-2/3 flex flex-col gap-4 justify-center">
            <MediaCarousel className="outline-base-content outline-2 flex-1">
              <Image
          ...
          <div className="flex-1 font-light text-base-content flex-col gap-4 flex">
            ...
            <div className="card flex-1 p-2 md:p-4 bg-base-100 text-base-content/95 text-sm">
              <div className="max-h-full overflow-y-auto w-full flex flex-col gap-2">
                <h1 className="font-bold text-lg text-success">ReFlows</h1>
                {new Array(10).fill(0).map((_, i) => (
                  <div key={`reflow-${i}`} className="flex flex-row gap-4 items-center">
                    <a className="link">{i ^ 0x312412343}-saeed-hassan</a>
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start">
          ...
          <div className="flex-1 flex flex-col gap-4 self-stretch">
            <div className="md:h-[15rem] card p-4 bg-secondary-content text-seconary border-secondary border flex flex-col justify-start items-start">
