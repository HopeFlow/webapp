...
export const redirectToCreateAccount = (props: {
...
> = new Map([
  ...
  [
    "Chat",
    {
      pathRegExp: /^\/chat\/(?<questId>[^/]+)\/(?<nodeId>[^/]+)$/,
...
export const redirectTo = (urlString: string): never => {
  ...
  switch (routeName) {
    ...
    case "CreateAccount":
      return redirectToCreateAccount(props as any);
    case "Login":
